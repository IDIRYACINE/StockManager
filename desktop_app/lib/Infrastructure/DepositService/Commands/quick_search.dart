...
class QuickSearchDeposit extends Command<QuickSearchDepositEventData,
    QuickSearchDepositRawEventData, QuickSearchDepositResponse> {
  ...
  QuickSearchDeposit(this.graphQl) : super(eventId, eventName);

  @override
  Future<QuickSearchDepositResponse> handleEvent(
      QuickSearchDepositEventData eventData) {
...
class QuickSearchDepositEvent extends ServiceEvent<QuickSearchDepositResponse> {
  QuickSearchDepositEvent({required super.eventData, super.callback})
      : super(QuickSearchDeposit.eventId, QuickSearchDeposit.eventName,
            QuickSearchDeposit.serviceId);
}
