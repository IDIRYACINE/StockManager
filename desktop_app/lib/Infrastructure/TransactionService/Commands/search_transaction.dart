  ...
  class SearchTransaction extends Command<SearchTransactionEventData, SearchTransactionRawEventData,
  ...
  SearchTransaction() : super(eventId, eventName);

  @override
  Future<SearchTransactionResponse> handleEvent(SearchTransactionEventData eventData) async {
  ...
  SearchTransactionRawEventData({required int messageId, required String requesterId})
      : super(messageId, requesterId, SearchTransaction.eventId);
  }

  class SearchTransactionEventData extends ServiceEventData<SearchTransactionRawEventData> {
  SearchTransactionEventData(super.requesterId);

  @override
  SearchTransactionRawEventData toRawServiceEventData() {
    return SearchTransactionRawEventData(messageId: messageId, requesterId: requesterId);
  }
  }
...
class SearchTransactionEvent extends ServiceEvent<SearchTransactionResponse> {
  SearchTransactionEvent({required super.eventData, super.callback})
      : super(SearchTransaction.eventId, SearchTransaction.eventName, SearchTransaction.serviceId);
}
