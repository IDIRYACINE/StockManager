...
class LoadProductModels extends Command<LoadProductModelsEventData,
    LoadProductModelsRawEventData, LoadProductModelsResponse> {
  ...
  LoadProductModels(this.graphQl) : super(eventId, eventName);

  @override
  Future<LoadProductModelsResponse> handleEvent(
      LoadProductModelsEventData eventData) {
...
class LoadProductModelsEvent extends ServiceEvent<LoadProductModelsResponse> {
  LoadProductModelsEvent({required super.eventData, super.callback})
      : super(LoadProductModels.eventId, LoadProductModels.eventName,
            LoadProductModels.serviceId);
}
