...
void main() {
  ...
  test('LoadSellers', () async {
    final command = sellers_service.LoadSellers(client);
  ...
  test("Insert Seller", () async {
    final command = sellers_service.RegisterSeller(client);

    final eventData =
        sellers_service.RegisterSellerEventData(seller: dummySeller);
  ...
  test("Delete Seller", () async {
    final command = sellers_service.DeleteSeller(client);

    final eventData =
        sellers_service.DeleteSellerEventData(seller: dummySeller,requesterId: "test");
  ...
  test("Update Seller", () async {
    final command = sellers_service.UpdateSeller(client);

    final eventData =
        sellers_service.UpdateSellerEventData(seller: dummySeller,requesterId: "test");
